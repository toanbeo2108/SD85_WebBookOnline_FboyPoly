...
{
    public class BookDetailEmployeeController : Controller
    {
        string _mess = "";
        bool _stt = false;
        object _data = null;
        private HttpClient _httpClient;
        public BookDetailEmployeeController()
        {
        ...
        [HttpGet]
        public async Task<IActionResult> AllBookDetailEpl()
        {
        ...
        [HttpGet]
        public async Task<IActionResult> CreateBookDetailEpl()
        {
            var urlBook = $"https://localhost:7079/api/Book/get-all-book";
            var responBook = await _httpClient.GetAsync(urlBook);
            string apiDataBook = await responBook.Content.ReadAsStringAsync();
        ...
        [HttpPost, Route("add-bookDetailEpl")]
        public async Task<IActionResult> CreateBookDetailEpl(BookDetail bk)
        {
            //var urlBook = $"https://localhost:7079/api/Book/get-all-book";
            //var responBook = await _httpClient.GetAsync(urlBook);
            //string apiDataBook = await responBook.Content.ReadAsStringAsync();
        ...
        [HttpGet, Route("detail-bookdetailEpl/{id}")]
        public async Task<IActionResult> BookDetailDetailEpl(Guid id)
        {
            var urlBook = $"https://localhost:7079/api/Book/get-all-book";
            var responBook = await _httpClient.GetAsync(urlBook);
            string apiDataBook = await responBook.Content.ReadAsStringAsync();
