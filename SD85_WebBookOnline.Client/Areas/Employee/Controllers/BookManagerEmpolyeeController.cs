...
//{
//    public class BookManagerEmpolyeeController : Controller
//    {
//        bool _stt = false;
//        string _mess = "";
//        object _data = null;
...
//        public BookManagerEmpolyeeController(IWebHostEnvironment hostingEnvironment)
//        {
...
//            //var token = Request.Cookies["Token"];
//            //_httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
//            //return RedirectToAction("AllBookManager", "BookManager", new { area = "Empoyee" });
//            if (respon.StatusCode == System.Net.HttpStatusCode.OK)
//            {
