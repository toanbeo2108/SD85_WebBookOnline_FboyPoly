...
{
    public class InputSlipEmployeeController : Controller
    {
       
            HttpClient _httpClient;
            public string userIDGet { get; set; }
            public InputSlipEmployeeController()
            {
            ...
            [HttpGet]
            public async Task<IActionResult> AllInputElp()
            {
            ...
            public async Task<IActionResult> CreateIPElp()
            {
                string UserId = Request.Cookies["UserID"];
                userIDGet = UserId;
                return View();
            }
            [HttpPost, Route("themm-inputslipelp")]
            public async Task<IActionResult> CreateIPElp(InputSlip ip)
            {
                var token = Request.Cookies["Token"];
                _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                string _mess = "";
            ...
            [HttpGet, Route("detail-inpelp/{id}")]
